...
namespace MVVMExample
{
    ...
    /// Esta função funciona principalmente quando se tem algo como um texto de uma label com o Binding e queremos mudar-lo em tempo real, para isso tem se notificar o elemento que esse texto mudou
    /// </summary>
